  ...
  return (
    <>
      <img
        ...
        alt="background"
        className="z-[-1] absolute object-cover w-full h-full object-center"
      />
      <div className="flex flex-col w-full h-screen items-center justify-center z-10 m-auto p-4 px-10 space-y-10 ">
        ...
        <div className="flex flex-col  items-center justify-center z-10 p-4 px-10 font-pretendard">
        ...
        <button className="bg-[#FAE100] rounded-md text-center w-full max-w-sm h-10 p-2 px-4 flex items-center">
          ...
          <p className="text-center text-[#371D1E] text-base m-auto font-pretendard">
            카카오로 시작하기
          </p>
        </button>
      </div>
