      ...
      >
        <defs>
          ...
          >
            ...
            ></animate>
            <stop offset="0%" stopColor="rgba(255, 0, 255, 0.2)"></stop>
          ...
          >
            <animate
              ...
              repeatCount="indefinite"
            ></animate>
            <stop offset="0%" stopColor="rgba(255, 255, 0, 0.2)"></stop>
          ...
          >
            <animate
              ...
              repeatCount="indefinite"
            ></animate>
            <stop offset="0%" stopColor="rgba(0, 255, 255, 0.2)"></stop>
          ...
          >
            <animate
              ...
              repeatCount="indefinite"
            ></animate>
            <stop offset="0%" stopColor="rgba(0, 255, 0, 0.2)"></stop>
          ...
          >
            <animate
              ...
              repeatCount="indefinite"
            ></animate>
            <stop offset="0%" stopColor="rgba(0,0,255, 0.2)"></stop>
          ...
          >
            <animate
              ...
              repeatCount="indefinite"
            ></animate>
            <stop offset="0%" stopColor="rgba(255,0,0, 0.2)"></stop>
